...
public class PortEndpointToggle {
    ...
    private void refresh() {
        ...
        button.getToolTip()
            .clear();
        button.getToolTip()
            .add(Component.translatable("create_nest_network.package_port.transit_endpoint"));
        button.getToolTip()
            .add(Component.translatable(endpoint
                ? "create_nest_network.package_port.endpoint_on"
                : "create_nest_network.package_port.endpoint_off")
