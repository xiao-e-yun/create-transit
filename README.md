...
The development client also loads [JEI](https://github.com/mezz/JustEnoughItems)
(`jei_version`) and the archived
[JEI Integration](https://github.com/SnowShock35/JEI-Integration)
(`jei_integration_file`, a CurseForge file id — list candidates via
<https://api.cfwidget.com/265917>). Both are `runtimeOnly`: the shipped mod
neither needs nor notices them.
